// Eigener Bootstrap statt des generierten: nur damit fontFallbackBaseUrl gesetzt
// werden kann. Ohne diese Zeile holt sich die Web-Engine ihre Ersatzschriften
// (Roboto, Noto Symbols) direkt von fonts.gstatic.com — bei jedem Seitenaufruf
// und ohne Einwilligung des Besuchers. Die beiden Dateien liegen stattdessen
// unter web/fallback-fonts/ im eigenen Paket.
//
// Alles ausser dem config-Block muss dem generierten Standard entsprechen:
// fehlt hier serviceWorkerSettings, startet die Engine nicht durch und die
...
_flutter.loader.load({
  serviceWorkerSettings: {
    serviceWorkerVersion: "904201515" /* Flutter's service worker is deprecated and will be removed in a future Flutter release. */,
  },
  config: {
